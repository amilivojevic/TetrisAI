# -*- coding: utf-8 -*-
"""
Created on Wed Jan 18 01:31:11 2017
...
def fit_reinforcement(model, reinforcer, batch_size, epoch_size, nb_epochs):
    ...
    f = open('C:\\Users\\Korisnik\\Desktop\\F\\4.godina\\Advanced Topics in AI\\New folder\\results5.txt','w')
    ...
    for epoch in range(nb_epochs):
        for batch in xrange(epoch_size):
            ...
            p = '\r%d / %d' % (batch, epoch_size)
            print(p, end='')
            f.write(p + "\n")
        
        p = '\r%d / %d :: Deaths = %d :: Score = %d' % (epoch+1,
                                                          nb_epochs,
